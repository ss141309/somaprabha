...
import AnimatedSVG from '../../src/components/AnimatedSVG.astro';
...
<AnimatedSVG folder="gap-buffer/inserting_1_in_array" />
...
position where the operation has to be performed and then insert the
characters:

<AnimatedSVG folder="gap-buffer/inserting_in_gapbuffer" />
